...
if __name__ == '__main__':
    ...
    df_expert = pd.read_csv('workout_coor/new test data/new_shoulderpress_expert.csv')
    ...
    while True:
        ...
        with open('new.csv', 'a') as csvfile: 
            ...
            try:
                ...
                '''body_list_shoulderpress = [[str(humans[0].body_parts[2]), 
                    str(humans[0].body_parts[3]), str(humans[0].body_parts[4]), str(humans[0].body_parts[5]), 
                    str(humans[0].body_parts[6]), str(humans[0].body_parts[7])]]'''
                ...
                #print(len(body_list_shoulderpress[-1]))
                #if len(body_list_shoulderpress[-1]) == 6: #wait for all joints to be in frame
