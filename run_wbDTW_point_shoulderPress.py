        ...
        with open('new.csv', 'a') as csvfile: 
            ...
            try:
                ...
                if len(humans[0].body_parts.keys())-1 == 17:
                    ...
                    rightX_dist.append(dtw.distance(uxR_list[:line], exR_list[:line]))
                    rightY_dist.append(dtw.distance(uyR_list[:line], eyR_list[:line]))

                    leftX_dist.append(dtw.distance(uxL_list[:line], exL_list[:line]))
                    leftY_dist.append(dtw.distance(uyL_list[:line], eyL_list[:line]))
                    
                    dist.append(rightX_dist[-1]+rightY_dist[-1]+leftX_dist[-1]+leftY_dist[-1])
                    print(dist[-1])
