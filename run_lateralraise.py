...
df_expert = pd.read_csv('workout_coor/test_lateralraises.csv')
        ...
        with open('out.csv', 'a') as csvfile: 
            ...
            try:
                ...
                if len(humans[0].body_parts.keys())-1 == 17:
                    ...
                    if line % 2 == 0:
                        if line >= 100:
                            right_dist.append(dtw.distance(rightArm_uangles[line-100:line], rightArm_eangles[line-100:line]))
                            left_dist.append(dtw.distance(leftArm_uangles[line-100:line], leftArm_eangles[line-100:line]))
                        else:
